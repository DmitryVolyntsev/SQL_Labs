...
CREATE TABLE HOTEL (
	hotel_id integer IDENTITY(100,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE LOCATION (
	location_id integer IDENTITY(36,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE ROOM (
	room_id integer IDENTITY(1000,1) NOT NULL PRIMARY KEY,
	hotel_id integer,
	class_id integer NOT NULL);


CREATE TABLE ORDERS (
	order_id integer IDENTITY(601,1) NOT NULL PRIMARY KEY,
	traveler_id integer NOT NULL,
	room_id integer,
	starts_date datetime NOT NULL,
	end_date datetime NOT NULL);
ALTER TABLE ORDERS ADD CHECK (starts_date <= '01/01/2017' and starts_date >= '01/01/2000')
ALTER TABLE ORDERS ADD CHECK (end_date <= '01/01/2017' and end_date >= '01/01/2000')
ALTER TABLE ORDERS ADD CHECK (starts_date <= end_date)
